...
export class YieldPredictionService {
   ...
   */
  private calculateSoilQuality(soilMetrics: SoilMetrics): number {
    let quality = 0;
    let factors = 0;
   ...
   */
  private calculateNutrientBalance(crop: Crop, soilMetrics: SoilMetrics, fertilizer: Fertilizer): number {
   ...
   */
  private calculatePHOptimality(pH: number): number {
